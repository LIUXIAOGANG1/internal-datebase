            ...
            <form class="form" action="ExpressCheckout" method="POST">
               <div class="row-fluid">
                  <div class="span6 inner-span">
                        ...
                        <table>
                        <input type="hidden" name="L_PAYMENTREQUEST_0_AMT" value="<%=request.getAttribute("PAYMENTREQUEST_0_AMT")%>" >
					...
					<tr><td colspan="2">
						<input id="p_method_paypal_express" value="paypal_express" type="radio" name="payment[method]" title="PayPal Express Check out" class="radio" checked>
					...
					<tr><td colspan="2"><input id="p_method_paypal_express" value="paypal_express" type="radio" name="payment[method]" title="PayPal Express Check out" class="radio" readonly>&nbsp;Credit Card</td></tr>
					<tr><td>&nbsp;</td></tr>
